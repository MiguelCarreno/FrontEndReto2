function traerUsuarios(){
    console.log("test");
        $.ajax({
        url:"http://144.22.238.58:8080/api/user/all",
...
function guardarUsuario(){
    ...
    let var2 = {
        ...
        url:"http://144.22.238.58:8080/api/user/new",
...
function actualizarUsuario(idElemento){
    ...
    $.ajax({
        url:"http://144.22.238.58:8080/api/user/update",
        type:"PUT",
        data:dataToSend,
...
function borrarUsuario(idElemento){
    ...
    $.ajax({
        url:"http://144.22.238.58:8080/api/user/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function editarUsuario(id) {
    ...
    $.ajax({
        dataType: 'json',
        url:"http://144.22.238.58:8080/api/user/"+id,
        type: 'GET',
        success: function (respuesta) {
            console.log(respuesta);
            var item = respuesta;
