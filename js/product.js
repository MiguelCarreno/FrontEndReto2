function traerProductos(){
    console.log("test");
        $.ajax({
        url:"http://144.22.238.58:8080/api/chocolate/all",
...
function guardarProducto(){
    ...
    let var2 = {
        ...
        url:"http://144.22.238.58:8080/api/chocolate/new",
...
function actualizarProducto(idElemento){
    ...
    $.ajax({
        url:"http://144.22.238.58:8080/api/chocolate/update",
        type:"PUT",
        data:dataToSend,
...
function editarProducto(reference) {
    ...
    $.ajax({
        dataType: 'json',
        url:"http://144.22.238.58:8080/api/chocolate/"+reference,
        type: 'GET',
        success: function (response) {
            console.log(response);
            var item = response;
